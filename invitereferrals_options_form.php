...
<div class="Invitereferrals_col">
    ...
    <tr>
        ...
        <td id="key-holder" width="366" style="padding:5px;"><input placeholder="Got a InviteReferrals Secret key? Enter it here." id="invitereferrals_secret_key" name="<?php echo $this->plugin_id; ?>[secretkey]" type="text" value="<?php echo $options['secretkey']; ?>" size="40" /></td>
    </tr>      
          
    <tr>
        <td width="144" height="26" align="right" style="padding:0 30px 0 0;vertical-align: top;"><label style="font-weight:600" for="<?php echo $this->plugin_id; ?>[encryptedkey]">Encrypted Key:</label> </td>
        <td id="key-holder" width="366" style="padding:5px;"><input placeholder="Got a InviteReferrals Encrypted key? Enter it here." id="invitereferrals_key" name="<?php echo $this->plugin_id; ?>[encryptedkey]" type="text" value="<?php echo $options['encryptedkey']; ?>" size="40" /></td>
    </tr>

    <tr>
        <td width="144" height="16" align="right"></td>
        <td width="366" style="border-bottom: 1px solid #CCC;padding:0 0 10px 0;"><p style="margin-top:3px;font-size:10px;">You will get these credentials in InviteReferrals admin panel -> "Integration". You may Click <a href="http://www.invitereferrals.com/campaign/brand/">here</a> to sign up on InviteReferrals.</p></td>
    </tr>          
          
          
    <tr>
        <td width="144" height="26" align="right" style="margin-top:20px;padding:0 30px 0 0;vertical-align: top;"><label style="font-weight:600" for="<?php echo $this->plugin_id; ?>[enable_rewards]">Enable:</label> </td>
